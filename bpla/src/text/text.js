function Text() {
    const text = {block1: 
       <div style={{textAlign:"left", paddingLeft: "0%"}}>my-react-app/<br/>
        ...
        │   │   │   ├── Footer.jsx<br/>
        │   │   ├── Form/<br/>
        │   │   │   ├── AddSelectField.css<br/>
        │   │   │   ├── AddTextField.css<br/>
        │   │   │   ├── AddSelectField.jsx<br/>
        │   │   │   ├── AddTextField.jsx<br/>
        │   ├── pages<br/>
        │   │   ├── Form/<br/>
        │   │   │   ├── Form.jsx<br/>
        ...
        └── ...</div>
        , 
        block2: <div style={{textAlign:"left", paddingLeft: "0%"}}>my-react-app/<br/>
        Основные компоненты и их назначение:<br/>
        <br/>
        App.js: <br/>
            Корневой компонент приложения. Он отвечает за маршрутизацию и отображение различных страниц в зависимости от URL.<br/>
        <br/>
        index.js: <br/>
            Точка входа в React-приложение. Он подключает корневой компонент App к DOM.<br/>
        <br/>
        PouchDB:<br/>
            pouchdb.js: Файл, содержащий конфигурацию и инициализацию PouchDB, локальной базы данных, используемой для хранения данных анкет и шаблонов.<br/>
        <br/>
        Компоненты (components/):<br/>
            ConfirmationDialog/ConfirmationDialog.jsx: Переиспользуемый компонент для отображения модального окна с подтверждением. Используется для подтверждения удаления анкеты или шаблона.<br/>
            Header.jsx: Компонент для отображения шапки сайта.<br/>
            Footer.jsx: Компонент для отображения подвала сайта.<br/>
        <br/>
    Страницы (pages/):<br/>
        <br/>
    Form/Form.jsx:<br/>
        Назначение: Страница для заполнения анкеты на основе шаблона.<br/>
        <br/>
        Функции:<br/>
            Загрузка шаблона из PouchDB по templateId.<br/>
            Отображение полей формы на основе данных шаблона.<br/>
            Сохранение заполненной анкеты в PouchDB.<br/>
        <br/>
        Компоненты:<br/>
            DisplayModeSection: Отображает поля формы в режиме просмотра.<br/>
            Tag: Генерирует тег для анкеты и предлагает сохранить ее.<br/>
            Edit_Mode: Отображает поля формы в режиме редактирования (для редактирования шаблона).<br/>
            Form_Header: Заголовок формы, содержащий название и кнопку переключения режима редактирования.<br/>
        <br/>
        Функции в компоненте:<br/>
            handleInputChange: Обновляет состояние formData при изменении значения поля.<br/>
            handleComplete: Обработчик завершения заполнения формы. Передает данные в Tag.<br/>
        <br/>
    Form/Edit_Mode.jsx:<br/>
        Назначение: Компонент для редактирования шаблона формы (добавление, удаление, изменение полей).<br/>
        <br/>
        Функции:<br/>
            Отображение полей формы в режиме редактирования.<br/>
            Предоставление возможности добавлять новые поля.<br/>
            Предоставление возможности удалять существующие поля.<br/>
            Предоставление возможности изменять метки полей.<br/>
            <br/>
        Вспомогательные компоненты:<br/>
            AddTextField: Компонент для добавления текстового поля.<br/>
            AddSelectField: Компонент для добавления выпадающего списка.<br/>
            <br/>
    Form/cp_Form/DisplayModeSection.jsx:
        Назначение: Компонент для отображения полей формы в режиме просмотра (без возможности редактирования).<br/>
        <br/>
        Функции:<br/>
            Отображение текстовых полей.<br/>
            Отображение выпадающих списков.<br/>
            Отображение других типов полей.<br/>
            <br/>
        Функции:<br/>
