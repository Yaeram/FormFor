...
//     const addField = (newField) => {
//         if (newField.type === 'select' && (newField.selectType === 'image' || newField.selectType === 'video')) {
//             // Если это выпадающий список с изображениями/видео, создаем несколько полей для загрузки файлов
//             const newFields = newField.options.map(option => ({
//                 id: uuidv4(),
//                 label: `${newField.label} - ${option}`, // Метка для поля загрузки файла
//                 type: newField.selectType, // Тип поля (image или video)
//                 value: null, // Начальное значение
//                 relatedOption: option, // Связываем поле с определенным вариантом ответа
//             }));
//             setFormFields([...formFields, ...newFields]);
//         } else {
//             // Для других типов полей просто добавляем одно поле
//             let initialValue = '';
//             if (newField.type === 'image' || newField.type === 'video') {
//                 initialValue = null;
//             }
